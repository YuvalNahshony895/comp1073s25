...
output.textContent = `The array within myArray has ${myArray[3].length} elements`;
output.textContent = "";
...
output.textContent = orig6Array[1];
// Output the last element of the array
output.textContent =  `The last element of orig 6 is: ${orig6Array[orig6Array.length-1]}`;
...
let orig6Length = orig6Array.push("Buffalo Sabres");
output.textContent = orig6Length;
...
let newOrig6Array = orig6Array.pop()
output.textContent = newOrig6Array;
...
output.textContent = removedItem;
output.textContent = orig6Array;
unremovedElement = orig6Array.unshift("hello");
output.textContent = orig6Array;
